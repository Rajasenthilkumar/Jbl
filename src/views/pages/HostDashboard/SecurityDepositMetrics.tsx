...
const SecurityDepositMetrics = () => {
  return (
    <div className="bg-white br10 p-3">
      <div className="flex">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 guest-dashboard-grid my-4">
        ...
        <TransactionDetailCard
          ...
          contentname={''}
          subheadingClassname="text-black-color text-lg font-medium d-flex w100 custom-text-truncate"
          subheading={'3'}
          imgClassname={''}
...
export default SecurityDepositMetrics;
