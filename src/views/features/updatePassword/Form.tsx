...
type Props = {
  onFinish: (data: ResetPasswordFormType) => void;
  isSubmitting: boolean;
  mode: 'Host' | 'Guest';
};

const UpdatePasswordForm: FC<Props> = ({ onFinish, isSubmitting, mode }) => {
  const { control, handleSubmit, setValue } = useForm<ResetPasswordFormType>({
    defaultValues: {
      password: '',
      mode: mode,
    },
